...
import { deleteDetalleEvolucionPrescripcion } from '../../../redux/actions/detallesEvolucionesPrescripciones';
const DeleteDetalleEvolucionPrescripcion = ({deleteDetalleEvolucionPrescripcion }:any) => {
  ...
  return (
        <Modal title = {'Eliminar Evolucion Prescripcion'} image = {'https://images.pexels.com/photos/2882553/pexels-photo-2882553.jpeg?cs=srgb&dl=pexels-miguel-%C3%A1-padri%C3%B1%C3%A1n-2882553.jpg&fm=jpg'}>
            <p>¿Estás seguro de eliminar el detalle evolución y prescripción {nombre}</p>
            <div className = {styles.buttonContainer}>
                <button onClick = {() => {
                    deleteDetalleEvolucionPrescripcion(id)
                }}
...
export default connect(
    null,
    {deleteDetalleEvolucionPrescripcion}
)(DeleteDetalleEvolucionPrescripcion)