...
const editDetalleEvolucionPrescripcion = detallesEvolucionesPrescripciones.editDetalleEvolucionPrescripcion;


const EditDetalleEvolucionPrescripcion = (props:any) => {
      ...
      <>
        <Formik
            ...
            onSubmit = {(values, )=>{
                ...
                // props.editEvolucionPrescripcion( id ,{...values});
                // resetForm();
            }}
        >
            {
...
export default connect(
    null, 
    {editDetalleEvolucionPrescripcion}
)(EditDetalleEvolucionPrescripcion)