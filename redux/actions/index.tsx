...
import * as reservasCitas from './reservasCitas'
export {users, auth, profesionales, consultorios, especialidades, historiasClinicas, evolucionesPrescripciones, detallesEvolucionesPrescripciones, reservasCitas};